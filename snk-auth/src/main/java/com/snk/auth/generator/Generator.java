package com.snk.auth.generator;
...
public static void main(String[] args) {
        ...
        generateByTables(serviceNameStartWithI, packageName, "Cai.ChangJun", "snk-auth", "public_user");//li作者。test数据库名。user表名。
...
//              .setSuperMapperClass("cn.saytime.mapper.BaseMapper")
        ...
        config.setActiveRecord(false)
                .setAuthor(author)
                .setOutputDir("D:\\job\\spring-cloud-alibaba\\snk-auth\\src\\main\\java")//生成的java到文件夹下
