package com.snk.userprovider.generator;
...
public static void main(String[] args) {
        String packageName = "com.snk.userprovider";
        boolean serviceNameStartWithI = false;
        generateByTables(serviceNameStartWithI, packageName, "Cai.ChangJun", "user-provider", "waybill");//li作者。test数据库名。user表名。
...
//              .setSuperMapperClass("cn.saytime.mapper.BaseMapper")
        ...
        config.setActiveRecord(false)
                .setAuthor(author)
                .setOutputDir("D:\\job\\spring-cloud-alibaba\\user-provider\\src\\main\\java")//生成的java到文件夹下
