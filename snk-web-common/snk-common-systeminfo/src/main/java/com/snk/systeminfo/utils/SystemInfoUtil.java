package com.snk.systeminfo.utils;
...
public class SystemInfoUtil {
     ...
     * @return /
     */
    private static Map<String,Object> getDiskInfo(OperatingSystem os) {
     ...
     * @return /
     */
    private static Map<String,Object> getSwapInfo(GlobalMemory memory) {
     ...
     * @return /
     */
    private static Map<String,Object> getSystemInfo(OperatingSystem os){
