...
import com.snk.common.exception.FileNameLengthLimitExceededException;
import com.snk.common.utils.DateUtils;
import com.snk.common.utils.file.MimeTypeUtils;
...
public class FileUploadUtils
{
            ...
            throws FileUploadBase.FileSizeLimitExceededException
    {
        ...
        {
            throw new BusinessException("文件大小超过限制:"+DEFAULT_MAX_SIZE / 1024 / 1024);
        }
